...
class BodyParts extends React.Component {
  constructor(props) {
    ...
    var bodyParts = [
      {id: 'head', english: 'Head', translation: translations.head[id]},
      {id: 'ear', english: 'Ear', translation: translations.ear[id]},
      {id: 'eyes', english: 'Eyes', translation: translations.eyes[id]},
      {id: 'nose', english: 'Nose', translation: translations.nose[id]},
      {id: 'mouth', english: 'Mouth', translation: translations.mouth[id]},
      {id: 'neck', english: 'Neck', translation: translations.neck[id]},
      {id: 'chest', english: 'Chest', translation: translations.chest[id]},
      // {id: 'breast', english: 'Breast', translation: translations.breast[id]},
      // {id: 'ribs', english: 'Ribs', translation: translations.ribs[id]},
      // {id: 'heart', english: 'Heart', translation: translations.heart[id]},
      {id: 'tummy', english: 'Tummy', translation: translations.tummy[id]},
      {id: 'back', english: 'Back', translation: translations.back[id]},
      {
        id: 'shoulder',
        english: 'Shoulder',
        translation: translations.shoulder[id],
      },
      {id: 'elbow', english: 'Elbow', translation: translations.elbow[id]},
      {
        id: 'lowerArm',
        english: 'Lower Arm',
        translation: translations.lowerArm[id],
      },
      {id: 'hand', english: 'Hand', translation: translations.hand[id]},
      {
        id: 'fingers',
        english: 'Fingers',
        translation: translations.fingers[id],
      },
      {id: 'groin', english: 'Groin', translation: translations.groin[id]},
      {
        id: 'boysPrivates',
      ...
      // {id: 'penis', english: 'Penis', translation: translations.penis[id]},
      // {
      //   id: 'testicles',
      //   english: 'Testicles',
      ...
      // },
      {id: 'bottom', english: 'Bottom', translation: translations.bottom[id]},
      {id: 'thigh', english: 'Thigh', translation: translations.thigh[id]},
      {id: 'knee', english: 'Knee', translation: translations.knee[id]},
      {
        id: 'lowerLeg',
        english: 'Lower Leg',
        translation: translations.lowerLeg[id],
      },
      {id: 'toes', english: 'Toes', translation: translations.toes[id]},
      {
        id: 'plaster',
        english: 'Plaster',
  ...
  render() {
    ...
    var counterText =
      this.state.bodyPartCounter === 1
        ? this.state.bodyPartCounter + ' item'
        : this.state.bodyPartCounter + ' items';
    return (
  ...
  _renderRow(data) {
    ...
    return (
      <View style={styles.row} key={data.id}>
        <View style={{flex: 1}} />
        <TouchableOpacity
          style={{justifyContent: 'center', width: width - 99 * ratio}}
          activeOpacity={0.8}
          delayLongPress={150}
  ...
  _selectBodyPart(data) {
    ...
    //console.log(this.state.items.map((key, val) => val));
  ...
  _viewList() {
    ...
    var arrItems = Object.getOwnPropertyNames(this.state.items).map(
      key => data[key],
    );
    var arrFeels = Object.getOwnPropertyNames(this.state.feels).map(
      key => feels[key],
    );

    const pushAction = StackActions.push({
      routeName: 'ViewSelected',
      params: {
